  ...
  return (
    <>
      <div className="bg-white w-full p-8">
        <div className="max-w-full grid md:grid-cols-3 gap-8 mx-auto">
          <div className="flex flex-col justify-center items-center border-2 p-5 rounded-sm shadow-md  bg-white hover:scale-105 duration-150">
            ...
            <h1 className="text-3xl font-bold mt-4 text-center">Single User</h1>
          ...
          <div className="flex flex-col justify-center items-center border-2 p-5 rounded-sm shadow-md  bg-white hover:scale-105 duration-150">
            ...
            <h1 className="text-3xl font-bold mt-4 text-center">Double User</h1>
          ...
          <div className="flex flex-col justify-center items-center border-2 p-5 rounded-sm shadow-md  bg-white hover:scale-105 duration-150">
            ...
            <h1 className="text-3xl font-bold mt-4 text-center">Triple User</h1>
